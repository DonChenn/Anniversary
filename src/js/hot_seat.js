document.addEventListener('DOMContentLoaded', () => {
    ...
    const game_questions = [
        {
            ...
            options: ["Portra 400", "CineStill 400D", "Kodak Ultramax 400", "Kodak TMax 400"],
            correct_answer: "Kodak TMax 400"
        },
        {
            question: "Q2: How many tiktoks has Meow Meow been included in yours this past year?",
            options: ["3", "4", "5", "6"],
            correct_answer: "5"
        },
        {
        ...
        {
            question: "Q4: How many times have you and Meow Meow said i love you to each other on discord this past year?",
        ...
        {
            question: "Q6: How many Adventure Time episodes do you and Meow Meow have left?",
            options: ["29", "47", "10", "51"],
            correct_answer: "47"
        },
        {
            question: "Q7: How many times did you and Meow Meow collectively visit each other at LA/Irvine this past year?",
            options: ["1000", "25", "15", "30"],
            correct_answer: "25"
        },
        {
            question: "Q8: What is Meow Meow's favorite album this past year?",
            options: ["Clipse - Let God Sort Em Out", "Kalis Uchis - Sincerely,",
                "Quadeca - Vanisher, Horizon Scraper", "TWICE - THIS IS FOR"],
        ...
        {
            question: "Q10: How many photobooth pics do you and Meow Meow have in the google photos album?",
            options: ["7", "8", "9", "10"],
            correct_answer: "9"
        }
    ];
    ...
    function handle_answer(selected_option) {
        ...
        buttons.forEach(button => {
            ...
            if (button.textContent === selected_option && selected_option !== question_data.correct_answer) {
    ...
    document.addEventListener('keydown', (event) => {
        ...
        const is_near_chair = Math.abs(x - chair_x) < interaction_radius &&
            Math.abs(y - chair_y) < interaction_radius;

        const is_near_pengy = Math.abs(x - pengy_x) < interaction_radius &&
        ...
        if (is_near_pengy && localStorage.getItem('gameshow_complete')) {
            ...
            const reward_dialogue_manager = new dialogue_manager(dialogue_text_element, dialogues, dialogue_sound);
