document.addEventListener('DOMContentLoaded', () => {
    ...
    if (localStorage.getItem('crab_seen_intro') !== 'true') {
        ...
        let current_dialogue_manager = new dialogue_manager(dialogue_text_element, intro_dialogues, dialogue_sound);
    ...
    document.addEventListener('keydown', (event) => {
        ...
        const is_near_crystal = Math.abs(x - crystal_x) < interaction_radius &&
        ...
        if (is_near_crystal) {
            ...
            const winning_dialogue_manager = new dialogue_manager(dialogue_text_element, crystal_dialogues, dialogue_sound);
